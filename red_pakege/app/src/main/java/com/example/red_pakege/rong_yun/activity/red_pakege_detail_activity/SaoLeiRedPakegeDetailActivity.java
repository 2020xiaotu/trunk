...
public class SaoLeiRedPakegeDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void bindActionBar() {
        ActionBarUtil.initMainActionbar(SaoLeiRedPakegeDetailActivity.this,toolbar);
    }
    ...
    public static void startAty(Context context,String orderCode,int typeId){
        Intent intent = new Intent(context, SaoLeiRedPakegeDetailActivity.class);
...
//                ------------------------  头部数据 -------------------------------
                ...
                GlideLoadViewUtil.LoadCircleView(SaoLeiRedPakegeDetailActivity.this,fbImage,headTitleIv);
...
//                ---------------------------  列表数据 ------------------------------------
    ...
    private void bindHeadView() {
        View headView = LayoutInflater.from(SaoLeiRedPakegeDetailActivity.this).inflate(R.layout.saolei_red_pakege_detail_head_layout,null);
