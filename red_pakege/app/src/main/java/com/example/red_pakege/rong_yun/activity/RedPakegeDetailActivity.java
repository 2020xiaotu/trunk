...
import com.example.red_pakege.util.TimeUtils;
...
public class RedPakegeDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void bindActionBar() {
        ActionBarUtil.initMainActionbar(RedPakegeDetailActivity.this,toolbar);
    }
    ...
    public static void startAty(Context context,String orderCode,int typeId){
        Intent intent = new Intent(context, RedPakegeDetailActivity.class);
...
//        data.put("userId","4");
        HttpApiUtils.normalRequest(this, RequestUtil.PAKEGE_DETAIL, data, new HttpApiUtils.OnRequestLintener() {
            @Override
            public void onSuccess(String result, Headers headers) {
                ...
                if(currentTime>0||isLottery==null||isLottery==false){
                    isOver=false;
...
//                        }
                ...
                if(playerType==2){//庄家
                    ...
                    GlideLoadViewUtil.LoadCornersView(RedPakegeDetailActivity.this,avatar,12,headTitleIv);
...
//    ---------------------------- 列表数据 ---------------------------------------------------------------
    ...
    private View bindHeadView() {
        View headView = LayoutInflater.from(RedPakegeDetailActivity.this).inflate(R.layout.red_pakege_detail_head_layout,null);
