 ...
 */
public class GlideRetcTransformWithBorder extends BitmapTransformation {

    private static final int VERSION = 1;
    //这个ID值 随意
    private static final String ID = "jp.wasabeef.glide.transformations.GlideRetcTransformWithBorder." + VERSION;
    ...
    public GlideRetcTransformWithBorder(int dpRadius, int marginDp) {
        this(dpRadius, marginDp, CORNER_ALL, FIT_CENTER);
    }

    public GlideRetcTransformWithBorder(int dpRadius, int marginDp, int cornerType, @ScaleType int scaleType) {
    ...
    public boolean equals(Object o) {
        return o instanceof GlideRetcTransformWithBorder &&
                ((GlideRetcTransformWithBorder) o).radius == radius &&
                ((GlideRetcTransformWithBorder) o).diameter == diameter &&
                ((GlideRetcTransformWithBorder) o).margin == margin &&
                ((GlideRetcTransformWithBorder) o).cornerType == cornerType;
    }
