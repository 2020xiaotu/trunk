...
//        refreshLayout.setEnableLoadMore(false);
     ...
     */
    public static void succse(int pageNum, RefreshLayout refreshLayout, ConstraintLayout loadingLinear, LinearLayout nodataLinear, int size, boolean isLoadMore, boolean isRefresh, ArrayList<?> list) {
        if(!isLoadMore){
