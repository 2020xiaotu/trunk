...
//                .statusBarView(starusbar_view)
        ...
        switch (v.getId()){
            ...
            case R.id.rank_pop_iv:
                CommonSurePop commonSurePop = new CommonSurePop(RankActivity.this, false, "说明", "1、排行榜内容每小时更新一次，邀请榜，专享榜调取昨日数据，每天只刷新一次；\n" +
                        "2、日榜为当日排行榜信息的展示；\n" +
                        "3、周榜为本周排行榜信息的展示，即本周一至当日。\n" +
                        "4、月榜为本月排行榜信息的展示，即本月一号至当日；\n" +
                        "5、赌神榜参与彩票游戏场次小于100场的用户不进行显示。");
