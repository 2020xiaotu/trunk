...
public class AgentCenter2Activity extends BaseActivity implements View.OnClickListener, BasePopupWindow2.OnPopClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CommonToolbarUtil.initToolbar(this,"代理数据");
        initRecycler();
        initView();
        requestTodayData();
    }
    ...
    private void requestAgentReport(Date startDate, Date endDate) {
        ...
        HttpApiUtils.CpRequest(this, null,RequestUtil.AGENT_CENTER, data, new HttpApiUtils.OnRequestLintener() {
            ...
            public void onSuccess(String result, Headers headers) {
                ...
                agentCenterEntityArrayList.add(new AgentCenterEntity("邀请人数",agentReportEntity.getInvitePersonNum()));
                agentCenterEntityArrayList.add(new AgentCenterEntity("邀请红包收益",agentReportEntity.getYqRedPrice()));
                agentCenterEntityArrayList.add(new AgentCenterEntity("下级返佣",agentReportEntity.getTzFyPrice()));
    ...
    public void onPopClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.today_tv:
                choose_date_tv.setText("今日");
                requestTodayData();
                bottomChooseTimePop.dismiss();
                break;
            case R.id.yestoday_tv:
                choose_date_tv.setText("昨日");
                requestYesTodayData();
                bottomChooseTimePop.dismiss();
                break;
            case R.id.week_tv:
                choose_date_tv.setText("近7日");
                requestThisWeekData();
                bottomChooseTimePop.dismiss();
                break;
            case R.id.month_tv:
                choose_date_tv.setText("本月");
