...
//                   count=1;
                   ...
                   childName=childManageModelArrayList.get(position).getName();
                    whoChild.setText(childManageModelArrayList.get(position).getName()+"的下级");
                    nickNameEdit.setText("");
                    invateEdit.setText("");
                    /*
                    没有下级,显示没有数据
                     */
                    if(childManageModelArrayList.get(position).getChildNUm().equals("0人")){
...
//                ProgressDialogUtil.stop(ChildManageActivity.this);
                ...
                for (int i=0;i<teamList.size();i++) {
                    ...
                    childManageModelArrayList.add(
                            new ChildManageModel(nickname,pointGrade,childNums+"人",loginDate,registerDate,
