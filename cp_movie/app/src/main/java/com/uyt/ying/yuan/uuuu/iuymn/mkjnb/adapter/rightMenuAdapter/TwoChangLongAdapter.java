...
public class TwoChangLongAdapter extends CommonAdapter<TwoChangLongAdapter.MyHolder, TwoChangLongMedol> {
    ...
    public void handleViewHolder(MyHolder commonHolder, int position) {
        ...
        if(game==8){//广东快乐10分
            data.put("1", Utils.getString(R.string.diyiqiu)+"-");
            data.put("2",Utils.getString(R.string.dierqiu)+"-");
            data.put("3",Utils.getString(R.string.disanqiu)+"-");
            data.put("4",Utils.getString(R.string.disiqiu)+"-");
            data.put("5",Utils.getString(R.string.diwuqiu)+"-");
            data.put("6",Utils.getString(R.string.diliuqiu)+"-");
            data.put("7",Utils.getString(R.string.diyiqiu)+"-");
            data.put("8",Utils.getString(R.string.dibaqiu)+"-");
        }else if(game==3){//赛车
            data.put("1",Utils.getString(R.string.guanjun)+"-");
            data.put("2",Utils.getString(R.string.yajun)+"-");
            data.put("3","第三名-");
            data.put("4","第四名-");
            data.put("5","第五名-");
            data.put("6","第六名-");
