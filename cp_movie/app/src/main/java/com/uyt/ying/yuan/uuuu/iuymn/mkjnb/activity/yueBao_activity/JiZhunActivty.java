...
public class JiZhunActivty extends BaseActivity {
    ...
    private void initRecycleData() {
        upLevelRewardModelArrayList.add(new UpLevelRewardModel("时间","操作","余额宝余额","有效份额"));
        upLevelRewardModelArrayList.add(new UpLevelRewardModel("00:00~23:50","未转入","1W","1W"));
        upLevelRewardModelArrayList.add(new UpLevelRewardModel("23:50","转入2W","3W","3W"));
        upLevelRewardModelArrayList.add(new UpLevelRewardModel("23:55","转出1W","2W","2W"));
        upLevelRewardModelArrayList.add(new UpLevelRewardModel("00:05","转入1W","3W","2W"));
        upLevelRewardModelArrayList.add(new UpLevelRewardModel("00:10","转出0.5W","2.5W","2W"));
        upLevelRewardModelArrayList.add(new UpLevelRewardModel("00:15","转出1W","1.5W","1.5W"));
    }
    private void bindView() {
        actionBarTextTv=findViewById(R.id.action_bar_text);
        actionBarTextTv.setText("基准收益");
