...
//    private TextView yueTv;
    ...
    private void initTabViewPager() {
        titles.add(getString(R.string.woyaotouzhu));
        titles.add(getString(R.string.zuijintouzhu));
    ...
    private void bindView() {
        ...
        actionCenterTv.setText(Utils.getString(R.string.changlongzhushou));
...
//        yueTv=findViewById(R.id.yue_textview);
    ...
    switch (v.getId()){
        ...
        case R.id.changlong_help:
            ...
            popBarCenter.setText(Utils.getString(R.string.changlongshuoming));
