    ...
    public void onSupportVisible() {
        ...
        if(getActivity() instanceof RankActivity){
            ...
            if(title.equals(MINGXING)){
                ...
                one_amount_tv.setText("礼物 - - -");
                two_amount_tv.setText("礼物 - - -");
                three_amount_tv.setText("礼物 - - -");
                ...
                two_level_iv.setVisibility(View.VISIBLE);
                three_level_iv.setVisibility(View.VISIBLE);
                one_amount_tv.setText("奖金:****");
                two_amount_tv.setText("奖金:****");
                three_amount_tv.setText("奖金:****");
                three_guideline.setGuidelinePercent(0.428f);
                two_guideline.setGuidelinePercent(0.428f);
                one_guideline.setGuidelinePercent(0.376f);
                ...
                three_level_iv.setVisibility(View.VISIBLE);
                //礼物  红包 场次初始化
                one_amount_tv.setText("场次 - - -");
                two_amount_tv.setText("场次 - - -");
                three_amount_tv.setText("场次 - - -");

                three_win_rate_tv.setText("胜率: - - -");
                two_win_rate_tv.setText("胜率: - - -");
                one_win_rate_tv.setText("胜率: - - -");
                //专享 邀请 布局高度初始化
                three_guideline.setGuidelinePercent(0.428f);
                two_guideline.setGuidelinePercent(0.428f);
                ...
                two_level_iv.setVisibility(View.VISIBLE);
                three_level_iv.setVisibility(View.VISIBLE);
                one_amount_tv.setText("红包 - - -");
                two_amount_tv.setText("红包 - - -");
                three_amount_tv.setText("红包 - - -");
            ...
            public void onItemClick(@NonNull BaseQuickAdapter<?, ?> adapter, @NonNull View view, int position) {
                ...
                if(viewType==1){
                    ...
                    if(status.equals("1")){
                        ...
                        showToast(Utils.getString(R.string.zhuboyixiabo));
                    }
                }
            }
        });
...
//                }
            ...
            public void onSuccess(String result, Headers headers) {
                ...
                if(size<50){
                    for (int i = size; i < 50; i++) {
                        ...
                        mineRankEntity.setNickname("等待上榜");
                        mineRankEntity.setUserNickName("等待上榜");
    ...
    private void initRankThree(RankEntity.RankingListBean threeBean) {
        ...
        if(title.equals(MINGXING)){
            ...
            three_amount_tv.setText(threeBean.getRedPrice().contains("礼物")?threeBean.getRedPrice():"礼物: "+threeBean.getRedPrice());
            ...
            if(title.equals(GONGXIAN)){
                ...
                three_amount_tv.setText(threeBean.getAnchorGift().contains("礼物")?threeBean.getAnchorGift():"礼物: "+threeBean.getAnchorGift());
                ...
                if(StringMyUtil.isEmptyString(zjNum)){
                    ...
                    three_amount_tv.setText("场次: "+ tzNum +"中"+ zjNum);//设置中奖场次
                    if(zjNum==0){
                        three_win_rate_tv.setText("胜率： 0.00%");
                    }else {
                        three_win_rate_tv.setText("胜率: "+new BigDecimal(Double.parseDouble(zjNum+"")/Double.parseDouble(tzNum+"")*100).setScale(2,BigDecimal.ROUND_HALF_DOWN)+"%");//设置中奖比例
                    }
                }
                setHeadLevelIv(threeBean.getGrade(),three_level_iv);
            }else if(title.equals(YAOQING)){
                three_name_tv.setText(threeBean.getNickname());
                three_amount_tv.setText(threeBean.getTotalQuYueHBPrice().contains("红包")?threeBean.getTotalQuYueHBPrice():"红包: "+threeBean.getTotalQuYueHBPrice());
                setHeadLevelIv(threeBean.getGrade(),three_level_iv);
            }else if(title.equals(ZHUANXIANG)){
                three_name_tv.setText(threeBean.getNickname());
                three_amount_tv.setText(threeBean.getTotalZxHBPrice().contains("红包")?threeBean.getTotalZxHBPrice():"红包: "+threeBean.getTotalZxHBPrice());
                setHeadLevelIv(threeBean.getGrade(),three_level_iv);
            }
        }
    }
...
//            level_iv.setImageResource(Utils.getLevelDrawble(grade));
    ...
    private void initRankTwo(RankEntity.RankingListBean twobean) {
        ...
        if(title.equals(MINGXING)){
            ...
            two_amount_tv.setText(twobean.getRedPrice().contains("礼物")?twobean.getRedPrice():"礼物: "+twobean.getRedPrice());
            ...
            if(title.equals(GONGXIAN)){
                ...
                two_amount_tv.setText(twobean.getAnchorGift().contains("礼物")?twobean.getAnchorGift():"礼物: "+twobean.getAnchorGift());
...
//                two_amount_tv.setText(twobean.getZjPrice());
                ...
                if(StringMyUtil.isEmptyString(zjNum)){
                    ...
                    two_amount_tv.setText("场次: "+ tzNum +"中"+ zjNum);//设置中奖场次
                    if(zjNum==0){
                        two_win_rate_tv.setText("胜率： 0.00%");
                    }else {
                        two_win_rate_tv.setText("胜率: "+new BigDecimal(Double.parseDouble(zjNum+"")/Double.parseDouble(tzNum+"")*100).setScale(2,BigDecimal.ROUND_HALF_DOWN)+"%");//设置中奖比例
                    }
                }
                setHeadLevelIv(twobean.getGrade(),two_level_iv);
            }else if(title.equals(YAOQING)){
                two_name_tv.setText(twobean.getNickname());
                two_amount_tv.setText(twobean.getTotalQuYueHBPrice().contains("红包")?twobean.getTotalQuYueHBPrice():"红包: "+twobean.getTotalQuYueHBPrice());
                setHeadLevelIv(twobean.getGrade(),two_level_iv);
            }else if(title.equals(ZHUANXIANG)){
                two_name_tv.setText(twobean.getNickname());
                two_amount_tv.setText(twobean.getTotalZxHBPrice().contains("红包")?twobean.getTotalZxHBPrice():"红包: "+twobean.getTotalZxHBPrice());
                setHeadLevelIv(twobean.getGrade(),two_level_iv);
            }
        }
    ...
    private void initRankOne(RankEntity.RankingListBean oneBeen) {
        ...
        if(title.equals(MINGXING)){
            ...
            one_amount_tv.setText(oneBeen.getRedPrice().contains("礼物")?oneBeen.getRedPrice():"礼物: "+oneBeen.getRedPrice());
            ...
            if(title.equals(GONGXIAN)){
                ...
                one_amount_tv.setText(oneBeen.getAnchorGift().contains("礼物")?oneBeen.getAnchorGift():"礼物: "+oneBeen.getAnchorGift());
                ...
                if(StringMyUtil.isEmptyString(zjNum)){
                    ...
                    one_amount_tv.setText("场次: "+ tzNum +"中"+ zjNum);//设置中奖场次
                    if(zjNum==0){
                        one_win_rate_tv.setText("胜率： 0.00%");
                    }else {
                        one_win_rate_tv.setText("胜率: "+new BigDecimal(Double.parseDouble(zjNum+"")/Double.parseDouble(tzNum+"")*100).setScale(2,BigDecimal.ROUND_HALF_DOWN)+"%");//设置中奖比例
                    }
                }
                setHeadLevelIv(oneBeen.getGrade(),one_level_iv);
            }else if(title.equals(YAOQING)){
                one_name_tv.setText(oneBeen.getNickname());
                one_amount_tv.setText(oneBeen.getTotalQuYueHBPrice().contains("红包")?oneBeen.getTotalQuYueHBPrice():"红包: "+oneBeen.getTotalQuYueHBPrice());
                setHeadLevelIv(oneBeen.getGrade(),one_level_iv);
            }else if(title.equals(ZHUANXIANG)){
                one_name_tv.setText(oneBeen.getNickname());
                one_amount_tv.setText(oneBeen.getTotalZxHBPrice().contains("红包")?oneBeen.getTotalZxHBPrice():"红包: "+oneBeen.getTotalZxHBPrice());
                setHeadLevelIv(oneBeen.getGrade(),one_level_iv);
            }
        }
