    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        switch (itemViewType) {
            ...
            case 1:
                ...
                itemViewHolder.betRebate.setText("赔 "+happy8Medol.getRebate());
...
//        if(position ==0 ||position ==5||position ==12||position==15||position==28||position==32||position==37) {
        if(happy10MedolList.get(0).getGroupname().equals(Utils.getString(R.string.liangmian)+"-"+Utils.getString(R.string.diyiqiu))){
