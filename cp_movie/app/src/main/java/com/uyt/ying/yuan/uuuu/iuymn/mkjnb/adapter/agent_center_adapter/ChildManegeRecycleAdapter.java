...
public class ChildManegeRecycleAdapter extends RecyclerView.Adapter<ChildManegeRecycleAdapter.MyHolder> implements View.OnClickListener {
    ...
    myHolder.ljfy.setText(childManageModelArrayList.get(i).getCommission()+"元");
    myHolder.dqye.setText(childManageModelArrayList.get(i).getAmount()+"元");
    myHolder.zcsj.setText(format2);
    myHolder.zhdl.setText(format1);
    myHolder.wjlx.setText(childManageModelArrayList.get(i).getAgentLevel()+"级代理");
