        ...
        try{
            ...
            switch (itemViewType){
                ...
                case 4:
                    ...
                    shareSpanBuilder.append(" 在 "+liveMessageModel.getTypeName()+Utils.getString(R.string.zhongxiazhule)+liveMessageModel.getBetAmount()+"元  ",defaultColorSpan,Spanned.SPAN_INCLUSIVE_INCLUSIVE);
...
//                initLevelIcon(level,string,userName,managerType,true);
                ...
                case 5:
                    ...
                    giftSpanBuilder.append(userName+"  送了" + giftName + " x" + giftNum,foregroundColorSpan,Spanned.SPAN_INCLUSIVE_INCLUSIVE);
                ...
                case 6:
                    ...
                    if(liveMessageModel.getStatus().equals("0")){
                        s=Utils.getString(R.string.jinruzhibojian);
                    }else {
                        s=Utils.getString(R.string.tuichuzhibojian);
                    }
...
//                initLevelIcon(level, exitSpan,userName,managerType,true);
                ...
                case 7:
                    ...
                    zjStringBuilder.append("   恭喜",defaultColorSpan,Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                    zjStringBuilder.append(liveMessageModel.getUserNickName(),foregroundColorSpan,Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                    zjStringBuilder.append("在"+liveMessageModel.getTypeName()+"中奖了",defaultColorSpan,Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                ...
                case 8:
                    ...
                    SpannableString followSpanStr = new SpannableString(liveMessageModel.getUserName()+" 关注了主播");
...
/*                if(managerType.equals("2")){
                ...
                case 12:
                    ...
                    if(liveMessageModel.isRongConnect()){
                        connectStatus="弹幕连接成功";
                    }else {
                        connectStatus="弹幕连接断开，正在重新连接";
                    }
                ...
                case 15:
                    ...
                    reward_content_tv.setText(String.format("%s打赏主播%s元",userName,liveMessageModel.getRewardPrice()));
                    break;
                default:
                    break;
            }
    ...
    public void setRedItem(int redType,String userName,String redPrice,String textContent,TextView contentTv,int position){
        if(redType==QUEYUE_RED||
           ...
           redType == NORMAL_RED){
            ...
            int drawble;
            if(redType==QUEYUE_RED){
                redString = new SpannableString(" 恭喜本直播间 "+userName+"抢到了"+redPrice+"元邀请红包。点击领取红包>");
                drawble = R.drawable.flhb;
            }else if(redType == ZHUANXIANG_RED) {
                redString = new SpannableString(" 恭喜本直播间 "+userName+"抢到了"+redPrice+"元专享红包。点击领取红包>");
...
//                        MyImageSpan iconSpan = new MyImageSpan(fragment.getContext(),R.drawable.flhb);
            ...
            SpannableString redStringPt = new SpannableString(" "+userName+" 发了一个普通红包。点击领取红包>");
            //点击领取红包字体颜色span
