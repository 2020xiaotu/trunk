        ...
        HttpApiUtils.CPnormalRequest(this,null, RequestUtil.REQUEST_13r, new HashMap<String, Object>(), new HttpApiUtils.OnRequestLintener() {
            ...
            public void onSuccess(String result, Headers headers) {
                ...
                if ("1".equals(islimit)) {  //限制
                    k3Rate_edit.setHint("自身返点" + initFloat(k3Rate) + ",可设置返点" + (k3Rate - max > 0 ? initFloat(k3Rate - max) : 0) +
                            "-" +initFloat(k3Rate - min));
                    sscaiRate_edit.setHint("自身返点" + initFloat(sscaiRate) + ",可设置返点" + (sscaiRate - max > 0 ?initFloat(sscaiRate - max) : 0) +
                            "-" +initFloat(sscaiRate - min));
                    raceRate_edit.setHint("自身返点" + initFloat(raceRate) + ",可设置返点" + (raceRate - max > 0 ? initFloat(raceRate - max) : 0) +
                            "-" + initFloat(raceRate-min));
                    sixRate_edit.setHint("自身返点" + initFloat(sixRate) + ",可设置返点" + (sixRate - max > 0 ? initFloat(sixRate-max) : 0) +
                            "-" +initFloat(sixRate - min));
                    happy8Rate_edit.setHint("自身返点" + initFloat(happy8Rate) + ",可设置返点" + (happy8Rate - max > 0 ? initFloat(happy8Rate - max) : 0) +
                            "-" + initFloat(happy8Rate - min));
                    farmRate_edit.setHint("自身返点" + initFloat(farmRate) + ",可设置返点" + (farmRate - max > 0 ? initFloat(farmRate - max ): 0) +
                            "-" + initFloat(farmRate - min));
                    happytenRate_edit.setHint("自身返点" + initFloat(happytenRate) + ",可设置返点" + (happytenRate - max > 0 ?initFloat(happytenRate - max ) : 0) +
                            "-" + initFloat(happytenRate - min));
                    xuanwuRate_edit.setHint("自身返点" + initFloat(xuanwuRate) + ",可设置返点" + (xuanwuRate - max > 0 ?initFloat(xuanwuRate - max) : 0) +
                            "-" +initFloat(xuanwuRate - min));
                    danRate_edit.setHint("自身返点" + initFloat(danRate) + ",可设置返点" + (danRate - max > 0 ? initFloat(danRate - max) : 0) +
                            "-" + initFloat(danRate - min));
                } else {  //不限制
                    k3Rate_edit.setHint("自身返点" + initFloat(k3Rate) + ",可设置返点0-" + initFloat(k3Rate));
                    sscaiRate_edit.setHint("自身返点" + initFloat(sscaiRate) + ",可设置返点0-" + initFloat(sscaiRate));
                    raceRate_edit.setHint("自身返点" + initFloat(raceRate) + ",可设置返点0-" + initFloat(raceRate));
                    sixRate_edit.setHint("自身返点" + initFloat(sixRate) + ",可设置返点0-" + initFloat(sixRate));
                    happy8Rate_edit.setHint("自身返点" + initFloat(happy8Rate) + ",可设置返点0-" + initFloat(happy8Rate));
                    farmRate_edit.setHint("自身返点" + initFloat(farmRate) + ",可设置返点0-" + initFloat(farmRate));
                    happytenRate_edit.setHint("自身返点" + initFloat(happytenRate) + ",可设置返点0-" + initFloat(happytenRate));
                    xuanwuRate_edit.setHint("自身返点" + initFloat(xuanwuRate) + ",可设置返点0-" + initFloat(xuanwuRate));
                    danRate_edit.setHint("自身返点" + initFloat(xuanwuRate) + ",可设置返点0-" + initFloat(xuanwuRate));
                }
            }
