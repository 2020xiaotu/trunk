...
private String mobileNumSwitch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CommonToolbarUtil.initToolbar(this,"安全中心");
    ...
    private void initdata() {
        ...
        Utils.docking(dataLoginInfo, RequestUtil.REQUEST_13r, 1, new DockingUtil.ILoaderListener() {
            ...
            public void success(String content) {
                ...
                loginTime.setText("上次登录时间:"+format1);
...
//                String bankCard = memberInfo.getString("bankCard");//银行卡
                ...
                if(!StringMyUtil.isEmptyString(paypassword)){
                    num++;
                    modifiPayPassword.setText("修改提款密码");
                    havePayPassword=true;
                }
                else{
                    modifiPayPassword.setText("设置提款密码");
...
//                if(!StringMyUtil.isEmptyString(bankCard)){
                ...
                if(!StringMyUtil.isEmptyString(phone)){
                    num++;
                    phonePassword.setText("已绑定密保手机");
                    phonePassword1.setText(phone);
                    havePhone=true;
                }
                else {
                    phonePassword.setText("设置密保手机");
                    phonePassword1.setText("设置");
                    havePhone=false;
                }
...
//                finish();
                    ...
                    isExit.setTitle("提示");
                    isExit.setMessage("未设置提款密码,前去设置!");
...
//                    finish();
                        ...
                        if(mobileNumSwitch.equals("1")){//不需要绑定手机号
                            ...
                            AlertDialog isExit = new AlertDialog.Builder(this).create();
                            isExit.setTitle("提示");
                            isExit.setMessage("您未设置密保手机,请前往设置");
                            isExit.setButton(DialogInterface.BUTTON_NEGATIVE, "取消", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                }
