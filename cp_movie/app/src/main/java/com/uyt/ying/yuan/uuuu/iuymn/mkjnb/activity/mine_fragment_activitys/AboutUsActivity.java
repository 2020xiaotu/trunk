...
public class AboutUsActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CommonToolbarUtil.initToolbar(this,"关于我们");
    ...
    private void initRecycle() {
        ...
        aboutUsRecycleAdapter.setOnItemClickListener(new AboutUsRecycleAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                switch (position){
                    case 0:
                        toolbar_title_tv.setText("隐私声明");
                        webTitleTv.setText("隐私声明");
                        break;
                    case 1:
                        toolbar_title_tv.setText("法律说明");
                        webTitleTv.setText("法律说明");
                        break;
                    case 2:
                        toolbar_title_tv.setText("商务合作");
                        webTitleTv.setText("商务合作");
                        break;
                    case 3:
                        toolbar_title_tv.setText("联系我们");
                        webTitleTv.setText("联系我们");
                        break;
                    case 4:
                        toolbar_title_tv.setText("关于我们");
                        webTitleTv.setText("关于我们");
                        break;
                }
