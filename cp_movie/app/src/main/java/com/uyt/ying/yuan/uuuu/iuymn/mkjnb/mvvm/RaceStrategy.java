...
public class RaceStrategy implements GameRuleStrategy {
    ...
    public BetPopAllModel parseBetPopAllData(String str, GameTypeEnum typeEnum) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            betPopChildModel.setGroupname(Utils.getString(R.string.guanjun_danma));
        ...
        for (int i = childList2.size() - 4; i < childList2.size(); i++) {
            ...
            betPopChildModel.setRuleId(bean.getId());
            betPopChildModel.setGroupname(Utils.getString(R.string.guanya_he));
            betPopChildModel.setName(bean.getName());
            betPopChildModel.setOdds(bean.getOdds().setScale(3,BigDecimal.ROUND_HALF_UP));
            betPopChildModel.setSelect(false);
            betPopChildModelList.add(betPopChildModel);
        ...
        for (int i = 0; i < 4; i++) {
            ...
            betPopChildModel.setRuleId(bean.getId());
            betPopChildModel.setGroupname(Utils.getString(R.string.guanjun_liangmian));
            betPopChildModel.setName(bean.getName());
            betPopChildModel.setOdds(bean.getOdds().setScale(3,BigDecimal.ROUND_HALF_UP));
            betPopChildModel.setSelect(false);
            betPopChildModelList.add(betPopChildModel);
        ...
        betPopTabModel1.setName(Utils.getString(R.string.guanjun_danma));
        ...
        betPopTabModel2.setName(Utils.getString(R.string.guanya_he));
        ...
        betPopTabModel3.setName(Utils.getString(R.string.guanjun_liangmian));
