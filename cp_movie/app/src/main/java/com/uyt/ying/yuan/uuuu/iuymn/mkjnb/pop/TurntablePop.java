...
/*    String[] turntableString = new String[]{"苹 果 手 机 * 1", "18 元 现 金 劵*1", "主 播 名 片 * 1"
            , "推 广 至 尊 称 号 * 30 天", "VIP 发 言 权 限* 7 天", "188 元 现 金 劵 * 1",
            "入 场 特 效 * 7 天","魅 力 新 秀 荣 誉 称 号 * 30 天"};  //转盘显示的list*/

    String[] dataRemarkList = new String[]{"18 元 现 金 劵*1", "188 元 现 金 劵 * 1", "主 播 名 片 * 1"
            , "入 场 特 效 * 7 天", "VIP 发 言 权 限* 7 天", "推 广 新 秀 称 号 * 30 天",
            "推 广 至 尊 称 号 * 30 天"," 苹 果 手 机 * 1"};
        ...
        Utils.docking(data, RequestUtil.REQUEST_zz3, 1, new DockingUtil.ILoaderListener() {
            ...
            public void success(String content) {
                ...
                for (int i = 0; i < bonusRecordList.size(); i++) {
                    ...
                    spannableStringBuilder.append("恭喜",defaultSpan,Spanned.SPAN_INCLUSIVE_INCLUSIVE);
                    spannableStringBuilder.append(" "+nickname+" ",span,Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                    spannableStringBuilder.append("获得"+dataRemarkList[nextInt].replace(" ",""));
    ...
    private void initData() {
        ...
        Integer[] colors = new Integer[]{Color.parseColor("#DBBB68"), Color.parseColor("#D59941")
                ...
                , Color.parseColor("#DBBB68"),Color.parseColor("#D59941")};
/*        String[] dataRemarkList = new String[]{"18 元 现 金 劵*1", "188 元 现 金 劵 * 1", "主 播 名 片 * 1"
                , "入 场 特 效 * 7 天", "VIP 发 言 权 限* 7 天", "推 广 新 秀 称 号 * 30",
                "推 广 至 尊 称 号 * 30"," 苹 果 手 机 * 1"};*/
...
//                    Utils.logE("TAG", "onSuccess:sss: "+"rotateAgain下标:"+turntablePos[pos[index]] );
