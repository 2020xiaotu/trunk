...
public class ChildBetFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void getEvenData(ChildBetEvenModel childBetEvenModel){
        ...
        if(tabName.equals("全部")){
            remark="";
        }else if(tabName.equals(getString(R.string.yizhongjiang))){
            remark=getString(R.string.zhongjiang);
        }else  if(tabName.equals(getString(R.string.weizhongjiang))){
            remark=getString(R.string.weizhong);
        }else if(tabName.equals(getString(R.string.dengdaikaijiang))){
            remark=getString(R.string.dengdaikaijiang);
        }
                    ...
                    public void success(String content) {
                        ...
                        long l = Long.parseLong(createdDate);
                          String format = simpleDateFormat.format(l);
                                        ...
                                        jine.setText(amount.setScale(2,BigDecimal.ROUND_DOWN)+"元");
                                        ...
                                        zhongjinagjine.setText(bonus.setScale(2,BigDecimal.ROUND_DOWN)+"元");
                                        yingkui.setText(bonus.subtract(amount).setScale(2,BigDecimal.ROUND_DOWN)+"元");
