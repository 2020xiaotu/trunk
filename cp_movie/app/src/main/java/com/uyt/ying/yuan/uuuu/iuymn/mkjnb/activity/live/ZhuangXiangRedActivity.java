...
public class ZhuangXiangRedActivity extends BaseActivity {
    ...
    private static  String GET_ZX_RED="领取专享红包";
    private static  String UPDATE_LEVEL="提升等级";
    private static  String ALREADY_GET="已领取";
    ...
    private void requestZRedInfo() {
        HttpApiUtils.CPnormalRequest(this, null,RequestUtil.ZX_RED_INFO, new HashMap<String, Object>(), new HttpApiUtils.OnRequestLintener() {
            ...
            public void onSuccess(String result, Headers headers) {
                ...
                zx_tip_tv.setText("达到条件后投注推荐玩法即可享受投注金额的"+zxHBRate+"%专享回馈红包");
    ...
    private void initHbRule(RongcloudHBParameter.RongcloudHBParameterBean rongcloudHBParameter) {
        ...
        zx_target_grade_tv.setText("等级达到VIP"+zxHBGrade);
        zx_game_rule_tv.setText("1.只要您等级达到VIP" + zxHBGrade + "，投注推荐玩法即可享受投注金额的"+zxHBRate+"%专享回馈红包\n 2.达到VIP" + zxHBGrade + "的会员请第二天晚上12点前登录领取，过期作废，没有领取的不累计。\n 3.此活动随时可能取消，千万回馈红包送完为止。\n 4.此活动只有投注推荐玩法才能享受"+zxHBRate+"%专享红包。\n 5.没有达到等级的请抓紧时间提升自己的等级。");
                    ...
                    if(isReceive.equals("1")){//已领取完
                        ...
                        if(tzPrice.compareTo(BigDecimal.ONE)>0){//昨日投注金额大于0
                            ...
                            if(StringMyUtil.isEmptyString(message)){
                                message ="昨日"+Utils.getString(R.string.touzhu)+"金额未达标";
                            }
                            showToast(message);
                        }
                    }
    ...
    private void initToolBar() {
        CommonToolbarUtil.initToolbar(this,"专享红包");
    }
            ...
            public void success(String content) {
                ...
                if(membeyGradeObject!=null){
                    if(minePointGrade+1 <zxHBGrade){
                        ...
                        cannot_receive_amount_tv.setText(",还需充值"+needCharge+"元");
