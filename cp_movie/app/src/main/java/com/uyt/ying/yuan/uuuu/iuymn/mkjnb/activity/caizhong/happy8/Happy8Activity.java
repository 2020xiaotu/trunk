...
//                selecterList.clear();
        ...
        for (int i = 0; i < rulelistAll.size(); i++) {
            ...
            for (int j = 0; j < rulelist.size(); j++) {
                ...
                if(group_id==1){
                    Happy8Model happy8Medol = new Happy8Model(name, odds + "", id,Utils.getString(R.string.liangmian)+"-"+groupname);
        ...
        if(liangmian.isChecked()){
            Happy8Model happy8Medol = new Happy8Model(Utils.getString(R.string.zong_he), "", "",Utils.getString(R.string.liangmian)+"-"+Utils.getString(R.string.zong_he));
            ...
            happy8ModelArrayList.add(new Happy8Model(Utils.getString(R.string.qianhouhe),"","",Utils.getString(R.string.liangmian)+"-"+Utils.getString(R.string.qianhouhe)));
            ...
            happy8ModelArrayList.add(new Happy8Model(Utils.getString(R.string.danshuanghe),"","",Utils.getString(R.string.lianma)+"-"+Utils.getString(R.string.danshuanghe)));
            ...
            happy8ModelArrayList.add(new Happy8Model(Utils.getString(R.string.wuxing),"","",Utils.getString(R.string.wuxing)));
            ...
            happy8ModelArrayList.add(new Happy8Model(Utils.getString(R.string.zhengma),"","",Utils.getString(R.string.zhengma)));
        ...
        Utils.docking(data, RequestUtil.REQUEST_03ha, 0, new DockingUtil.ILoaderListener() {
            ...
            public void success(String content)  {
                ...
                if(StringMyUtil.isEmptyString(nowQishu)){//期数为空,表示封盘
                    ...
                    nowQishuText.setText("000000 期");
                    lastQiShuText.setText("0000000 "+Utils.getString(R.string.qikaijianghaoma));
                    hourText.setText("--");
                    minutesText.setText("--");
                    secondsText.setText("--");
                    handler.removeCallbacks(runnableRandom);
...
//                playTypeText.setText(temaRb.getText().toString());
    ...
    private void xingYongRandom() {
        ...
        for (int i = 0; i < selecterList.size(); i++) {
            ...
            if(betType.equals(Utils.getString(R.string.zong_he))||betType.equals(Utils.getString(R.string.qianhouhe))||betType.equals(Utils.getString(R.string.danshuanghe))||betType.equals(Utils.getString(R.string.wuxing))||betType.equals(Utils.getString(R.string.zhengma))){
                xingYongRandom();
            }else{
                break;
            }
