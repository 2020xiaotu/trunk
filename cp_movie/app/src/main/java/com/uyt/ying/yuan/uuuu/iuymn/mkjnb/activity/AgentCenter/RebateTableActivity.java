            ...
            public void success(String content) {
                ...
                if(isChuantong){
                    ...
                    for (int a =0;a<oldRuleList.size();a++) {
                        ...
                        oddsArrayList.add(new Odds(getString(R.string.fandian),getString(R.string.peilv)));//添加列表的第一项
...
//                        }
    ...
    private void showC1hooseTv(String game){
        switch (game){
            case "1":
                choose_linear_tv.setText(Utils.getString(R.string.kuaisan));
                break;
            case "2":
                choose_linear_tv.setText(Utils.getString(R.string.shishicai));
                break;
            case "3":
                choose_linear_tv.setText(Utils.getString(R.string.saiche));
                break;
            case "4":
                choose_linear_tv.setText(Utils.getString(R.string.liuhecai));
                break;
            case "5":
                choose_linear_tv.setText(Utils.getString(R.string.pcdandan));
                break;
            case "6":
                choose_linear_tv.setText(Utils.getString(R.string.kuaile8));
                break;
            case "7":
                choose_linear_tv.setText(Utils.getString(R.string.xingyunnongchang));
                break;
            case "8":
                choose_linear_tv.setText(Utils.getString(R.string.kuaileshifen));
                break;
            case "9":
                choose_linear_tv.setText(Utils.getString(R.string.shiyixuanwu));
                break;
