        ...
        iconView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ManualWebViewActivity.startAty(ChatHeadService.this,
                        StringMyUtil.isNotEmpty(currentManualEntity)?"充值":JSONObject.parseObject(currentManualEntity, ManualEntity.class).getShopNickName(),
                        StringMyUtil.isNotEmpty(currentManualEntity)?"没有路径":JSONObject.parseObject(currentManualEntity, ManualEntity.class).getOnlineService() );
            }
        });
