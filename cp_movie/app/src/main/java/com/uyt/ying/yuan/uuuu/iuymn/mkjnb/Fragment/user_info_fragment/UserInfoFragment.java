...
//                    showPickerViewTime();//弹出出生日期界面
            ...
            case R.id.user_phone_linear:
                ...
                if(havaePaypassword==null||havaePaypassword==""){
                    ...
                    isExit.setMessage("未设置提款密码.前往设置!!!");
                ...
                switch (index){
                    case 0://拍照
                        if(pointGrade>=editNicknameLevel){
                            ...
                            showToast(String.format("您需要达到达到vip%d，才能使用本地图片!",editNicknameLevel));
                        }
                        break;
                    case 1://相册
                        if(pointGrade>=editNicknameLevel){
