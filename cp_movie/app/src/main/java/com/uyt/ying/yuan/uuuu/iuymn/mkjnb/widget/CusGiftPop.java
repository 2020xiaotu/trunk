        ...
        tv_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(mList.size()>=2){
                    ...
                    ToastUtil.showToast("礼物列表获取失败,请重试");
                    return;
                }
...
//                level_iv.setImageResource(Utils.getLevelDrawble(Integer.parseInt(pointGrade)+1));
        ...
        if(pointGrade.equals(lastItem.getGrade())){
            need_amount_tv.setText("最高等级");
        }else {
            need_amount_tv.setText("需"+nextGradeNeedGrowthIntegral+"升级");
        }
    }
