...
//    private TextView nothing;//没有数据时的顶部提示控件
    ...
    private void initTime() {
       ...
       默认请求的数据
        ...
        //盈众申博默认请求7天的数据
        if(appName.equals(getString(R.string.yingzhongcaipiao))||appName.equals(getString(R.string.shenboguoji))){
...
//                refreshLoadMoreList.clear();
                ...
                for (int i=0;i<childCommissionList.size();i++) {
                    ...
                    rakeBackModelArrayList.add(new RakeBackModel(remark,createdDate,price+"元"));
//                    refreshLoadMoreList.add(new RakeBackModel(remark,createdDate,price+"元"));
                }
...
//                        .setDate(selectedDate)// 如果不设置的话，默认是系统时间*/
    ...
    /*private void showPickerViewTimeLeft() {
        ...
        // 设置标题
//        mTimePickerView.setTitle("设置生日");
        // 设置取消文字
        mTimePickerView.setCancelText("取消");
        // 设置取消文字颜色
        mTimePickerView.setCancelTextColor(Color.WHITE);
        // 设置取消文字大小
        mTimePickerView.setCancelTextSize(15f);
        // 设置确定文字
        mTimePickerView.setSubmitText("确定");
        // 设置确定文字颜色
