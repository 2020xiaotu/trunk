...
//                .apply(RequestOptions.bitmapTransform(new CircleCrop()))
        ...
        //期数
        commonHolder.qishuTv.setText("第"+itemModel.getQishu()+"期");
        //倒计时
...
//                 long days = currenTime / (1000 * 60 * 60 * 24);
        ...
        //期数2
        commonHolder.qishu2Tv.setText(itemModel.getQishu2()+"期");
        ...
        //左侧的赔率
        commonHolder.rebateOneTv.setText("奖"+itemModel.getRebateLeft());
        commonHolder.weizhiLeftRebate.setText("奖"+itemModel.getRebateLeft());
        //右侧的赔率
        commonHolder.rebateTwoTv.setText("奖"+itemModel.getRebateRight());
        commonHolder.weizhiRightRebate.setText("奖"+itemModel.getRebateRight());
