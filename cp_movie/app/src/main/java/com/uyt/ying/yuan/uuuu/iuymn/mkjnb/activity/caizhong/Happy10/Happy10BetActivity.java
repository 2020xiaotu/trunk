...
//    private PopupWindow fengpanPop;//封盘后需要弹出的pop
    private String[] bothTileList ={Utils.getString(R.string.diyiqiu),Utils.getString(R.string.dierqiu),Utils.getString(R.string.disanqiu),Utils.getString(R.string.disiqiu),Utils.getString(R.string.diwuqiu),Utils.getString(R.string.diliuqiu),Utils.getString(R.string.diqiqiu),Utils.getString(R.string.dibaqiu)};//两面 页面下每一组的groupName
                ...
                for (int j = 0; j < bothTileList.length; j++) {
                    ...
                    for (int k = 0; k < rulelist.size(); k++) {
                        ...
                        if(title.equals(groupname)){
                            Happy10Model happy8Model = new Happy10Model(name, odds+"", id, Utils.getString(R.string.liangmian)+"-" + groupname);
...
//                                Integer group_id = jsonObject2.getInteger("id");
                    ...
                    for (int j = 1; j < 21; j++) {
                        name=j+"";
                        Happy10Model happy8Model = new Happy10Model(name, odds + "", id, Utils.getString(R.string.lianma)+"-" + lianmaType);
        ...
        if(popPosition==0){
            Happy10Model happy8Medol = new Happy10Model(Utils.getString(R.string.diyiqiu), "", "",Utils.getString(R.string.liangmian)+"-"+Utils.getString(R.string.diyiqiu));
            ...
            happy10ModelList.add(new Happy10Model(Utils.getString(R.string.dierqiu),"","",Utils.getString(R.string.liangmian)+"-"+Utils.getString(R.string.dierqiu)));
            ...
            happy10ModelList.add(new Happy10Model(Utils.getString(R.string.disanqiu),"","",Utils.getString(R.string.liangmian)+"-"+Utils.getString(R.string.disanqiu)));
            ...
            happy10ModelList.add(new Happy10Model(Utils.getString(R.string.disiqiu),"","",Utils.getString(R.string.liangmian)+"-"+Utils.getString(R.string.disiqiu)));
            ...
            happy10ModelList.add(new Happy10Model(Utils.getString(R.string.diwuqiu),"","",Utils.getString(R.string.liangmian)+"-"+Utils.getString(R.string.diwuqiu)));
            ...
            happy10ModelList.add(new Happy10Model(Utils.getString(R.string.diliuqiu),"","",Utils.getString(R.string.liangmian)+"-"+Utils.getString(R.string.diliuqiu)));
            ...
            happy10ModelList.add(new Happy10Model(Utils.getString(R.string.diqiqiu),"","",Utils.getString(R.string.liangmian)+"-"+Utils.getString(R.string.diqiqiu)));
            ...
            happy10ModelList.add(new Happy10Model(Utils.getString(R.string.dibaqiu),"","",Utils.getString(R.string.liangmian)+"-"+Utils.getString(R.string.dibaqiu)));
            ...
            happy10ModelList.add(new Happy10Model(type,"","",type+"-"+Utils.getString(R.string.diyiqiu)));
            ...
            happy10ModelList.add(new Happy10Model(lianmaType,"","",Utils.getString(R.string.liangmian)+"-"+typename));
    ...
    private void bindView() {
        ...
        BetChoosePalyModel betChoosePalyModel = new BetChoosePalyModel(Utils.getString(R.string.liangmian));
        betChoosePalyModel.setStatus(1);
        betChoosePalyModelArrayList.add(betChoosePalyModel);
        betChoosePalyModelArrayList.add(new BetChoosePalyModel(Utils.getString(R.string.diyiqiu)));
        betChoosePalyModelArrayList.add(new BetChoosePalyModel(Utils.getString(R.string.dierqiu)));
        betChoosePalyModelArrayList.add(new BetChoosePalyModel(Utils.getString(R.string.disanqiu)));
        betChoosePalyModelArrayList.add(new BetChoosePalyModel(Utils.getString(R.string.disiqiu)));
        betChoosePalyModelArrayList.add(new BetChoosePalyModel(Utils.getString(R.string.diwuqiu)));
        betChoosePalyModelArrayList.add(new BetChoosePalyModel(Utils.getString(R.string.diliuqiu)));
        betChoosePalyModelArrayList.add(new BetChoosePalyModel(Utils.getString(R.string.diqiqiu)));
        betChoosePalyModelArrayList.add(new BetChoosePalyModel(Utils.getString(R.string.dibaqiu)));
        betChoosePalyModelArrayList.add(new BetChoosePalyModel(Utils.getString(R.string.lianma)));
        ...
        betChoosePlayAdapter.setOnItemClickListener(new CommonAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                if(position==betChoosePalyModelArrayList.size()-1){//点击连码按钮,显示连码玩法选择的button,并清空选中容器
                    ...
                    clearSelector();//取消选择
                    happy10Adapter.notifyDataSetChanged();
                }else{//点击除了 "连码"外的按钮,判断选中的容器中是否包含连码页面的item,如果有,说明是从连码界面跳转,同样清空选中的容器(直接clear,不用remove.
                    ...
                    for (int i = 0; i < selecterList.size(); i++) {
                        ...
                        if(happy8Model.getGroupname().contains(Utils.getString(R.string.lianma))){//只要有一个medel的groupname包含"连码",直接清空选中的容器
...
//            System.out.println("请求接口10s  isWait");
        }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.xingyong_play:
                showToast(Utils.getString(R.string.zanwuguangfangcai));
                break;
...
//                customPopupWindow.showHappy8TodayResultPop(todayOpenResultLinear,this);
            ...
            case R.id.random_button:
                ...
                if(lianmaGroup.getVisibility()!=View.VISIBLE){ //不是连码界面,随机选中一个
                    if(randomButton.getText().toString().equals(Utils.getString(R.string.jixuan))){
                        xingYongRandom();
                    }else{
            ...
            case R.id.bet_button:
                ...
                if(stopTv.getVisibility()==View.VISIBLE){
                    ...
                    if(lianmaOneBtn.isChecked()||lianmaTwoBtn.isChecked()){
                        if(size<2){
                            showToast(Utils.getString(R.string.qingxuanzewanfa));
    ...
    private void randomBet(ArrayList<Happy10Model> happy10MedolList,int num) {
        ...
        for (int i = 0; i < selecterList.size(); i++) {
            ...
            if(betType.equals(Utils.getString(R.string.renxuaner))|| betType.equals(R.string.renxuansan)|| betType.equals(Utils.getString(R.string.renxuansi))|| betType.equals(Utils.getString(R.string.renxuanwu))|| betType.equals(Utils.getString(R.string.xuanerlianzu))){
...
//                happy8Model.setBetType(betType);
    ...
    private void xingYongRandom() {
        ...
        for (int i = 0; i < selecterList.size(); i++) {
            String betType = selecterList.get(i).getBetType();
            if(betType.equals(Utils.getString(R.string.diyiqiu))||betType.equals(Utils.getString(R.string.dierqiu))||betType.equals(Utils.getString(R.string.disanqiu))
                    ||betType.equals(Utils.getString(R.string.disiqiu))||betType.equals(Utils.getString(R.string.diwuqiu))||betType.equals(Utils.getString(R.string.diliuqiu))
                    ||betType.equals(Utils.getString(R.string.diqiqiu))||betType.equals(Utils.getString(R.string.dibaqiu))){
                xingYongRandom();
            }else{
                break;
            }
