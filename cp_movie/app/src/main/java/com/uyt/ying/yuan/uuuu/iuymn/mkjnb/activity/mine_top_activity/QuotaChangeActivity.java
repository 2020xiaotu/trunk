...
public class QuotaChangeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CommonToolbarUtil.initToolbar(this,"额度转换");
        initRecycler();
        requestBalance("");
        //toolbar右侧图标
    ...
    public void onClick(View view){
        switch (view.getId()){
            case R.id.all_recycle_btn:
                ...
                if(!canRecycler){
                    ...
                    if(commonTipPop==null){
                        commonTipPop=new CommonTipPop(QuotaChangeActivity.this, QuotaChangeActivity.this,"一键回收","一键回收所有额度?");
            ...
            case R.id.quota_change_swich:
                if(!quota_change_swich.isChecked()){
                    ...
                    if(checkBle){
                        ...
                        showToast("开启自动余额转换失败,请手动回收所有金额");
                        quota_change_swich.setChecked(false);
                    }
                }
                break;
            ...
            case R.id.toolbar_right_iv:
                String tip="切换至自动额度转换前,请先通过手动转换将额度转换为账户余额";
                CommonTipPop commonTipPop = new CommonTipPop(QuotaChangeActivity.this, QuotaChangeActivity.this, "说明", tip);
