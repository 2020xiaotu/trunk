...
//                }
            ...
            lotteryListItem.setName(Utils.getString(R.string.quanbucaipiao));
            lotteryListItem.setLive(false);
            playLotteryList.add(lotteryListItem);
            /**
             * 限定玩法查询修改
...
//                    LogUtils.e("timeCount:" + timeCount);
                    ...
                    liveLotteryEntity.setCurrentQishu(qishu+"期");
                    liveLotteryData.postValue(liveLotteryEntity);
...
//                                                    LogUtils.e("开奖结果状态定时器"+aLong);
                    ...
                    liveLotteryEntity.setOpenQishu(lastLotteryEntity.getLotteryqishu() + "期开奖");
                    liveLotteryData.postValue(liveLotteryEntity);
...
//                Utils.logE(TAG, "onFinished: 动画重新开始结束");
//            }
//
//            @Override
