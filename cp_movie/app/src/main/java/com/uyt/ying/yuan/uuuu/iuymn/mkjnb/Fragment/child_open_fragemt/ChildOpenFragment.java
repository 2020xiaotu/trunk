    ...
    private void initData(View view) {
        ...
        Utils.docking(aboutPerson, RequestUtil.REQUEST_13r, 0, new DockingUtil.ILoaderListener() {
            ...
            public void success(String content) {
                ...
                if ("1".equals(islimit)) {  //限制
                    kuaisan.setHint("自身返点" + initFloat(k3Rate) + ",可设置返点" + (k3Rate - max > 0 ? initFloat(k3Rate - max) : 0) +
                            "-" +initFloat(k3Rate - min));
                    ssc.setHint("自身返点" + initFloat(sscaiRate) + ",可设置返点" + (sscaiRate - max > 0 ?initFloat(sscaiRate - max) : 0) +
                            "-" +initFloat(sscaiRate - min));
                    race.setHint("自身返点" + initFloat(raceRate) + ",可设置返点" + (raceRate - max > 0 ? initFloat(raceRate - max) : 0) +
                            "-" + initFloat(raceRate-min));
                    six.setHint("自身返点" + initFloat(sixRate) + ",可设置返点" + (sixRate - max > 0 ? initFloat(sixRate-max) : 0) +
                            "-" +initFloat(sixRate - min));
                    happy8.setHint("自身返点" + initFloat(happy8Rate) + ",可设置返点" + (happy8Rate - max > 0 ? initFloat(happy8Rate - max) : 0) +
                            "-" + initFloat(happy8Rate - min));
                    farm.setHint("自身返点" + initFloat(farmRate) + ",可设置返点" + (farmRate - max > 0 ? initFloat(farmRate - max ): 0) +
                            "-" + initFloat(farmRate - min));
                    happy10.setHint("自身返点" + initFloat(happytenRate) + ",可设置返点" + (happytenRate - max > 0 ?initFloat(happytenRate - max ) : 0) +
                            "-" + initFloat(happytenRate - min));
                    xuan5.setHint("自身返点" + initFloat(xuanwuRate) + ",可设置返点" + (xuanwuRate - max > 0 ?initFloat(xuanwuRate - max) : 0) +
                            "-" +initFloat(xuanwuRate - min));
                    dandan.setHint("自身返点" + initFloat(danRate) + ",可设置返点" + (danRate - max > 0 ? initFloat(danRate - max) : 0) +
                            "-" + initFloat(danRate - min));
                } else {  //不限制
                    kuaisan.setHint("自身返点" + initFloat(k3Rate) + ",可设置返点0-" + initFloat(k3Rate));
                    ssc.setHint("自身返点" + initFloat(sscaiRate) + ",可设置返点0-" + initFloat(sscaiRate));
                    race.setHint("自身返点" + initFloat(raceRate) + ",可设置返点0-" + initFloat(raceRate));
                    six.setHint("自身返点" + initFloat(sixRate) + ",可设置返点0-" + initFloat(sixRate));
                    happy8.setHint("自身返点" + initFloat(happy8Rate) + ",可设置返点0-" + initFloat(happy8Rate));
                    farm.setHint("自身返点" + initFloat(farmRate) + ",可设置返点0-" + initFloat(farmRate));
                    happy10.setHint("自身返点" + initFloat(happytenRate) + ",可设置返点0-" + initFloat(happytenRate));
                    xuan5.setHint("自身返点" + initFloat(xuanwuRate) + ",可设置返点0-" + initFloat(xuanwuRate));
                    dandan.setHint("自身返点" + initFloat(danRate) + ",可设置返点0-" + initFloat(danRate));
                }
    ...
    private boolean EditCheck() {
        ...
        if ("1".equals(islimit)) {
            if (Float.parseFloat(kuaisan.getText().toString()) < (FloatsetScale(k3Rate - max,1) > 0 ? FloatsetScale(k3Rate - max ,1): 0) || Float.parseFloat(kuaisan.getText().toString()) >(FloatsetScale(k3Rate - min,1))) {
                showToast(getString(R.string.kuaisanchaoqujian));
                return false;
                ...
                showToast(getString(R.string.sscchaoqujian));
                return false;
                ...
                showToast(getString(R.string.saichechaoqujian));
                return false;
                ...
                showToast(getString(R.string.liuhecaichaoqujian));
                return false;
                ...
                showToast(getString(R.string.dandanchaoqujian));
                return false;
                ...
                showToast(getString(R.string.kuaile8chaoqujian));
                return false;
                ...
                showToast(getString(R.string.nongchangchaoqujian));
                return false;
                ...
                showToast(getString(R.string.kuaile10chaoqujian));
                return false;
