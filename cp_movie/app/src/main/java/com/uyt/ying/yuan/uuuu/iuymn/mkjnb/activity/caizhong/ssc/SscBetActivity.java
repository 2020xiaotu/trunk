...
//                selecterList.clear();
            ...
            for (int i = 0; i < rulelistAll.size(); i++) {
                ...
                for (int j = 0; j < rulelist.size(); j++) {
                    ...
                    if (isboth == 0 && isball == 0) {//前中后的数据
                        if (group_id == 3) {
                            SscModel sscMedol = new SscModel(name, odds + "", id, Utils.getString(R.string.qianzhonghou)+"-" + groupname);
                            ...
                            SscModel sscMedol = new SscModel(name, odds + "", id, Utils.getString(R.string.daxiaodanshuang)+"-" + groupname);
                            ArrayList<String> idList = new ArrayList<>();
                            for (int a = 0; a < selecterList.size(); a++) {
                                String rule_id = selecterList.get(a).getRule_id();
                                idList.add(rule_id);
                        ...
                        if (group_id == 2) {
                            SscModel sscMedol = new SscModel(name, odds + "", id, Utils.getString(R.string.yidaowuqiu)+"-" + groupname);
                            if (balled == 1) {
                        ...
                        SscModel sscMedol = new SscModel(name, odds + "", id, Utils.getString(R.string.liangmian)+"-" + groupname);
                        if (balled == 0) {
            ...
            if (liangmianBtn.isChecked()) {
                SscModel sscMedol = new SscModel(Utils.getString(R.string.zonghe_longhuhe), "", "", Utils.getString(R.string.liangmian)+"-"+Utils.getString(R.string.zonghe_longhuhe));
                ...
                sscModelList.add(new SscModel(Utils.getString(R.string.diyiqiu), "", "", Utils.getString(R.string.liangmian)+"-"+Utils.getString(R.string.diyiqiu)));
                ...
                sscModelList.add(new SscModel(Utils.getString(R.string.dierqiu), "", "", Utils.getString(R.string.liangmian)+"-"+Utils.getString(R.string.dierqiu)));
                ...
                sscModelList.add(new SscModel(Utils.getString(R.string.disanqiu), "", "", Utils.getString(R.string.liangmian)+"-"+Utils.getString(R.string.disanqiu)));
                ...
                sscModelList.add(new SscModel(Utils.getString(R.string.disiqiu), "", "", Utils.getString(R.string.liangmian)+"-"+Utils.getString(R.string.disiqiu)));
                ...
                sscModelList.add(new SscModel(Utils.getString(R.string.diwuqiu), "", "", Utils.getString(R.string.liangmian)+"-"+Utils.getString(R.string.diwuqiu)));
                ...
                sscModelList.add(new SscModel(Utils.getString(R.string.diyiqiu), "", "", Utils.getString(R.string.yidaowuqiu)+"-"+Utils.getString(R.string.diyiqiu)));
                ...
                sscModelList.add(new SscModel(Utils.getString(R.string.dierqiu), "", "", Utils.getString(R.string.yidaowuqiu)+"-"+Utils.getString(R.string.dierqiu)));
                ...
                sscModelList.add(new SscModel(Utils.getString(R.string.disanqiu), "", "", Utils.getString(R.string.yidaowuqiu)+"-"+Utils.getString(R.string.disanqiu)));
                ...
                sscModelList.add(new SscModel(Utils.getString(R.string.disiqiu), "", "", Utils.getString(R.string.yidaowuqiu)+"-"+Utils.getString(R.string.disiqiu)));
                ...
                sscModelList.add(new SscModel(Utils.getString(R.string.diwuqiu), "", "", Utils.getString(R.string.yidaowuqiu)+"-"+Utils.getString(R.string.diwuqiu)));
                ...
                sscModelList.add(new SscModel(Utils.getString(R.string.qiansan), "", "", Utils.getString(R.string.qianzhonghouqiansan)));
                ...
                sscModelList.add(new SscModel(Utils.getString(R.string.zhongsan), "", "", Utils.getString(R.string.qianzhonghouzhongsan)));
                ...
                sscModelList.add(new SscModel(Utils.getString(R.string.housan), "", "",Utils. getString(R.string.qianzhonghouhousan)));
...
//        jgTime = customPopupWindow.getJgTIme(game, type_id);
    ...
    public void threeItemClick(SscOfficialChooseMedol sscOfficialChooseMedol) {
        ...
        String remarkStr = remark + ";最高奖金" + "<font color=\"#FF0000\">" + odds + "</font>" + "元";
        betShuoMingTv.setText(Html.fromHtml(remarkStr));
        maxAmountTv.setText(Html.fromHtml("最高可中" + "<font color=\"#FF0000\">" + new BigDecimal(odds).multiply(new BigDecimal(officialAmonnt + "")) + "</font>" + "元"));
 ...
 */
    public void itemClick(int position) {
        if(sscListOne.size()!=0){
            ...
            pcddTypeTextGf.setText(typeOneName + getString(R.string.fushi));
//        sscListThree.clear();
            ...
            for (int i = 0; i < playRuleListFour.size(); i++) {
                ...
                if (playRuleId.equals(threeId)) {
                    ...
                    if (i == 0 || i == 1 || i == 2 || i == 3 || i == 4) {//四级列表前5个item属于大小单双,需要单独的布局
                        sscOfiicialBetMedol.setTypeOneName(Utils.getString(R.string.daxiaodanshuang));
                    }
...
//                    fengpanPop.showAtLocation(actionBarBack, Gravity.CENTER, 0, 0);
                    ...
                    nowQishuText.setText("-- -- -- 期");
                    lastQiShuText.setText("-- -- -- "+Utils.getString(R.string.qikaijianghaoma));
                    hourText.setText("--");
                    minutesText.setText("--");
                    secondsText.setText("--");
                    handler.removeCallbacks(runnableRandom);
                    ...
                    nowQishuText.setText(nowQishu + " 期");
                    lastQiShuText.setText((Long.parseLong(nowQishu) - 1) + " "+Utils.getString(R.string.qikaijianghaoma));
        ...
        Utils.docking(data, RequestUtil.REQUEST_19r, 0, new DockingUtil.ILoaderListener() {
            ...
            public void success(String content) {
                ...
                if(happytenLotterylist.size()==0){
                    showToast(getString(R.string.kaijiangjieguohuoqushibai));
                    return;
                }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.stop_textview:
                showToast(Utils.getString(R.string.gaicaizhongyifengpan));
                break;
            case R.id.official_jixuan_tv:
                if (jixuanGfTv.getText().equals(getString(R.string.chongzhi))) {
                    initAllStatus();
                    jixuanGfTv.setText(getString(R.string.jixuan));
                    ...
                    sscOfficialAdapter.notifyDataSetChanged();
                    if (typeOneName.equals(getString(R.string.daxiaodanshuang))) {
                        max = randomOneItem(1);
                        allBetNum = BetNumUtil.oneToOne(officialSelectorList);
                    } else if (typeOneName.equals(getString(R.string.yixing))) {
                        max = randomOneItem(1);
                        allBetNum = BetNumUtil.oneToOne(officialSelectorList);
                    } else if (typeOneName.equals(getString(R.string.qianer)) || typeOneName.equals(getString(R.string.houer))) {
                        if (typeThreeName.equals(getString(R.string.zhixuanfushi))) {
//                            max = randomMoreItemOneNum();
                            randomMoreItemOneNum();
                            allBetNum = BetNumUtil.zhiXuanFuShi(officialSelectorList, typeOneName);
                        } else if (typeThreeName.equals(getString(R.string.zhixuanhezhi))) {
                            max = randomOneItem(1);
                            allBetNum = BetNumUtil.zhiXuanHeZhi(officialSelectorList, true, 2);
                        } else if (typeThreeName.equals(getString(R.string.zhuxuanfushi))) {
                            max = randomOneItem(2);
                            allBetNum = (int) BetNumUtil.combineWithArraySize(officialSelectorList.size(), 2);
                        } else if (typeThreeName.equals(getString(R.string.zuxuanhezhi))) {
                            max = randomOneItem(1);
                            allBetNum = (int) BetNumUtil.zhuXuanHeZhi(officialSelectorList, 2);
                        } else if (typeThreeName.equals(getString(R.string.zuxuanbaodan))) {
                            max = randomOneItem(1);
                            allBetNum = officialSelectorList.size() * 9;
                        }
                    } else if (typeOneName.equals(getString(R.string.qiansan)) || typeOneName.equals(getString(R.string.zhongsan)) || typeOneName.equals(getString(R.string.housan))) {
                        if (typeThreeName.equals(getString(R.string.fushi))) {
                            randomMoreItemOneNum();
//                            max =  randomMoreItemOneNum();
                            allBetNum = BetNumUtil.zhiXuanFuShi(officialSelectorList, typeOneName);
                        } else if (typeThreeName.equals(getString(R.string.zhixuanhezhi))) {
                        ...
                        } else if (typeThreeName.equals(getString(R.string.zusan))) {
                            max = randomOneItem(2);
                            allBetNum = (int) BetNumUtil.combineWithArraySize(officialSelectorList.size(), 2);
                            allBetNum = allBetNum * 2;
                        } else if (typeThreeName.equals(getString(R.string.zuliu))) {
                            max = randomOneItem(3);
                            allBetNum = (int) BetNumUtil.combineWithArraySize(officialSelectorList.size(), 3);
                        } else if (typeThreeName.equals(getString(R.string.zuxuanbaodan))) {
                            max = randomOneItem(1);
                            allBetNum = officialSelectorList.size() * 54;
                        } else if (typeThreeName.equals(getString(R.string.yimabudingwei))) {
                            max = randomOneItem(1);
                            allBetNum = officialSelectorList.size();
                        } else if (typeThreeName.equals(getString(R.string.ermabudingwei))) {
                            max = randomOneItem(2);
                            allBetNum = (int) BetNumUtil.combineWithArraySize(officialSelectorList.size(), 2);
                        }
                    } else if (typeOneName.equals(getString(R.string.sixing))) {
                        if (typeThreeName.equals(getString(R.string.fushi))) {
//                            max =   randomMoreItemOneNum();//多个布局没个item都要选中,不用滚动到底部
                            randomMoreItemOneNum();
                            allBetNum = BetNumUtil.zhiXuanFuShi(officialSelectorList, typeOneName);
                        } else if (typeThreeName.equals(getString(R.string.zuxuan34))) {
                            max = randomOneItem(4);
                            allBetNum = (int) BetNumUtil.combineWithArraySize(officialSelectorList.size(), 4);
                        } else if (typeThreeName.equals(getString(R.string.zuxuan12))) {
                            randomMoreItemMoreNum(2);
                            allBetNum = BetNumUtil.combinZuXuan12_4_60_20WithSectionArray(officialSelectorList, 2, 2);
                        } else if (typeThreeName.equals(getString(R.string.zuxuan6))) {
                            max = randomOneItem(2);
                            allBetNum = (int) BetNumUtil.combineWithArraySize(officialSelectorList.size(), 2);
                        } else if (typeThreeName.equals(getString(R.string.zuxuan4))) {
//                            max =   randomMoreItemOneNum();
                            randomMoreItemOneNum();
                    ...
                    } else if (typeOneName.equals(getString(R.string.wuxingxing))) {
                        if (typeThreeName.equals(getString(R.string.fushi))) {
                            randomMoreItemOneNum();
//                            max =    randomMoreItemOneNum();
                            allBetNum = BetNumUtil.zhiXuanFuShi(officialSelectorList, typeOneName);
                        } else if (typeThreeName.equals(getString(R.string.zuxuan120))) {
                            max = randomOneItem(5);
                            allBetNum = (int) BetNumUtil.combineWithArraySize(officialSelectorList.size(), 5);
                        } else if (typeThreeName.equals(getString(R.string.zuxuan60))) {
                            max = randomMoreItemMoreNum(3);
                            allBetNum = BetNumUtil.combinZuXuan12_4_60_20WithSectionArray(officialSelectorList, 3, 2);
                        } else if (typeThreeName.equals(getString(R.string.zuxuan30))) {
                            max = randomMoreItemMoreNumWuXin30(2);
                            allBetNum = BetNumUtil.combinZuXuan30WithSectionArray(officialSelectorList, 2, 2);
                        } else if (typeThreeName.equals(getString(R.string.zuxuan20))) {
                            max = randomMoreItemMoreNum(2);
                            allBetNum = BetNumUtil.combinZuXuan12_4_60_20WithSectionArray(officialSelectorList, 2, 2);
                        } else if (typeThreeName.equals(getString(R.string.zuxuan10)) || typeThreeName.equals(getString(R.string.zuxuan5))) {
                            randomMoreItemOneNum();
//                            max =   randomMoreItemOneNum();
                            ...
                            max = randomOneItem(2);
                            allBetNum = (int) BetNumUtil.combineWithArraySize(officialSelectorList.size(), 2);
                        } else if (typeThreeName.equals(getString(R.string.sanmabudingwei))) {
                            max = randomOneItem(3);
                            allBetNum = (int) BetNumUtil.combineWithArraySize(officialSelectorList.size(), 3);
                        } else if (typeThreeName.equals(getString(R.string.yifanfengshun)) || typeThreeName.equals(getString(R.string.haoshichengshuang)) || typeThreeName.equals(getString(R.string.sanxingbaoxi)) || typeThreeName.equals(getString(R.string.sijifacai))) {
                            max = randomOneItem(1);
                            allBetNum = BetNumUtil.oneToOne(officialSelectorList);
                        }
                    }
                    betNumGfTv.setText(allBetNum + "");
                    jixuanGfTv.setText(getString(R.string.chongzhi));
...
//                    officialbetRecy.smoothScrollToPosition(max);
            ...
            case R.id.yuan:
                ...
                if (!StringMyUtil.isEmptyString(odds)) {
                    ...
                    String str = "最高可中" + "<font color=\"#FF0000\">" + highAmount + "</font>" + "元";
            ...
            case R.id.jiao:
                ...
                if (!StringMyUtil.isEmptyString(odds)) {
                    BigDecimal highAmount = bigDecimal1.multiply(new BigDecimal(odds + "").divide(new BigDecimal(10 + "")).setScale(2, RoundingMode.HALF_UP));
                    String remarkStr = remark + ";最高奖金" + "<font color=\"#FF0000\">" + highAmount + "</font>" + "元";
                    betShuoMingTv.setText(Html.fromHtml(remarkStr));
                }
                //底部总投注金额
...
//                String  num1=   new BigDecimal(allBetAmountStr).divide(new BigDecimal(10+""))+"";
            ...
            case R.id.jian:
                ...
                if (yuanBtn.isChecked()) {
                    ...
                    maxAmountTv.setText(Html.fromHtml("最高可中" + "<font color=\"#FF0000\">" + new BigDecimal(odds).multiply(new BigDecimal(officialAmonnt + "")).divide(new BigDecimal(10 + "")) + "</font>" + "元"));
                }
                officialAmountEt.setSelection(officialAmountEt.getText().length());//将光标移动到末尾
            ...
            case R.id.sure_bet_gf:
                ...
                if(stopTv.getVisibility()==View.VISIBLE){
                    showToast(Utils.getString(R.string.dangqianicaizhongyifengpan));
                }
                else if (sizeGf == 0) {
                    showToast(getString(R.string.qingxuanzewanfa));
                } else if (StringMyUtil.isEmptyString(editTextGf)) {
                    showToast(Utils.getString(R.string.qingshuruxaizhujine));
                } else {
...
//                        allBetAmountStr  =   new BigDecimal(allBetAmountStr)/*.divide(new BigDecimal(10+""))*/+"";
            ...
            case R.id.xingyong_play:
                if(isopenOffice.equals("0")){
                    showToast(getString(R.string.zanwuguangfangcai));
                }else {
                    if (xingyongTv.getText().equals(getString(R.string.xingyongwanfa))) {
                        ...
                        xingyongTv.setText(getString(R.string.guanfangwanfa));
                    } else {
                        ...
                        xingyongTv.setText(getString(R.string.xingyongwanfa));
                    }
...
//                playTypeText.setText(boseRb.getText().toString());
            ...
            case R.id.random_button:
                int max = 0;
                if (randomButton.getText().toString().equals(getString(R.string.jixuan))) {
                    xingyongPlayRandom();
                } else {
                    ...
                    amountEdit.setText("");
                    betNum.setText(size + "");
                    randomButton.setText(getString(R.string.jixuan));
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ReqTouzhu) {
            ...
            sscAdapter.notifyDataSetChanged();
            sureBetPop.dismiss();
            randomButton.setText(Utils.getString(R.string.jixuan));
            getMoney();//投注后,更新资金信息
        }
    ...
    private void xingyongPlayRandom() {
        ...
        int size = selecterList.size();
        betNum.setText(size + "");
        randomButton.setText("重置");
        for (int i = 0; i < selecterList.size(); i++) {
            String betType = selecterList.get(i).getBetType();
            //因为布局中title也放在sscMedolList中,所以可能随机到title,此处做判断,如果随机到的是title,重新随机
            if (betType.equals("总和-龙虎和") || betType.equals(Utils.getString(R.string.diyiqiu)) || betType.equals(Utils.getString(R.string.dierqiu)) || betType.equals(Utils.getString(R.string.disanqiu)) || betType.equals(Utils.getString(R.string.disiqiu)) || betType.equals(Utils.getString(R.string.diwuqiu)) || betType.equals(Utils.getString(R.string.qiansan)) || betType.equals("中三") || betType.equals("后三")) {
                xingyongPlayRandom();
...
//                }
    ...
    public void requestBetGf(String amount) {
        NoAlphaProgressDialogUtil.show(SscBetActivity.this,"正在下注",false);
        String domain = SharePreferencesUtil.getString(SscBetActivity.this, "domain", "");
    ...
    public void initAllStatus() {
        ...
        sscOfficialAdapter.notifyDataSetChanged();
        gfSureBetPop.dismiss();
        jixuanGfTv.setText(Utils.getString(R.string.jixuan));
        officialAmonnt = 1;
        allBetNum = 0;
        betAmountGfTv.setText(0 + "");
        yuanBtn.performClick();
    ...
    private void requestBet(int size, String editText) {
        ...
        Utils.docking(data, RequestUtil.REQUEST_02ssc, 0, new DockingUtil.ILoaderListener() {
            ...
            public void failed(MessageHead messageHead) {
                ...
                showToast(Utils.getString(R.string.xiazhushibai)+"\n" + messageHead.getInfo());
                sureBetPop.dismiss();
...
//            }
    ...
    public void onItemClick(View view, int position) {
        ...
        if (oneToFiveBtn.isChecked()) {
            if (sscModel.getGroupname().equals(Utils.getString(R.string.yidaowuqiu)+"-"+Utils.getString(R.string.diyiqiu))) {
                if (sscModel.getStatus() == 1) {
                    diyiqiuSelectList.add(sscModel);
                    if (diyiqiuSelectList.size() > sscaiCount) {
                        showToast(getString(R.string.gaiwanfayiqibunengchaoguo) + sscaiCount + "个");
//                    SscModel sscModel1 = sscMedolList.get(position);
            ...
            } else if (sscModel.getGroupname().equals(Utils.getString(R.string.yidaowuqiu)+"-"+Utils.getString(R.string.dierqiu))) {

                if (sscModel.getStatus() == 1) {
                    dierqiuSelectList.add(sscModel);
                    if (dierqiuSelectList.size() > sscaiCount) {
                        showToast(getString(R.string.gaiwanfazhinengtongshixiazhu) + sscaiCount + "个");
//                    SscModel sscModel1 = sscMedolList.get(position);
                        sscModel.setStatus(0);
                        selecterList.remove(sscModel);
            ...
            } else if (sscModel.getGroupname().equals(Utils.getString(R.string.yidaowuqiu)+"-"+Utils.getString(R.string.disanqiu))) {
                if (sscModel.getStatus() == 1) {
...
//                    SscModel sscModel1 = sscMedolList.get(position);
            ...
            } else if (sscModel.getGroupname().equals(Utils.getString(R.string.yidaowuqiu)+"-"+Utils.getString(R.string.disiqiu))) {
                if (sscModel.getStatus() == 1) {
...
//                    SscModel sscModel1 = sscMedolList.get(position);
        ...
        if (size != 0) {
            randomButton.setText(Utils.getString(R.string.chongzhi));
        } else {
            randomButton.setText(Utils.getString(R.string.jixuan));
        }
    }
...
//        int num=0;
        if (typeOneName.equals(getString(R.string.yixing))) {
            allBetNum = BetNumUtil.oneToOne(officialSelectorList);
        } else if (typeOneName.equals(getString(R.string.qianer)) || typeOneName.equals(getString(R.string.houer))) {
            if (typeThreeName.equals(getString(R.string.zhixuanfushi))) {
                allBetNum = BetNumUtil.zhiXuanFuShi(officialSelectorList, typeOneName);
...
//                allBetNum+=num;
                ...
                allBetNum = (int) BetNumUtil.combineWithArraySize(officialSelectorList.size(), 2);
            } else if (typeThreeName.equals(getString(R.string.zhuxuanhezhi))) {
                allBetNum = (int) BetNumUtil.zhuXuanHeZhi(officialSelectorList, 2);
            } else if (typeThreeName.equals(getString(R.string.zuxuanbaodan))) {
            ...
            if (typeThreeName.equals(getString(R.string.fushi))) {
                allBetNum = BetNumUtil.zhiXuanFuShi(officialSelectorList, typeOneName);
            } else if (typeThreeName.equals(getString(R.string.zuxuan24))) {
                allBetNum = (int) BetNumUtil.combineWithArraySize(officialSelectorList.size(), 4);
            } else if (typeThreeName.equals(getString(R.string.zuxuan12))) {
                allBetNum = BetNumUtil.combinZuXuan12_4_60_20WithSectionArray(officialSelectorList, 2, 2);
            } else if (typeThreeName.equals(getString(R.string.zuxuan6))) {
...
//                allBetNum+=num;
            ...
            } else if (typeThreeName.equals("组选和值")) {
                allBetNum = (int) BetNumUtil.zhuXuanHeZhi(officialSeletorList, 3);
            } else if (typeThreeName.equals("组三")) {
                allBetNum = (int) BetNumUtil.combineWithArraySize(officialSeletorList.size(), 2);
                allBetNum = allBetNum * 2;
            } else if (typeThreeName.equals("组六")) {
                allBetNum = (int) BetNumUtil.combineWithArraySize(officialSeletorList.size(), 3);
            } else if (typeThreeName.equals("一码不定位")) {
                allBetNum = officialSeletorList.size();
            } else if (typeThreeName.equals("二码不定位")) {
                allBetNum = (int) BetNumUtil.combineWithArraySize(officialSeletorList.size(), 2);
            }
        } else if (typeOneName.equals("四星")) {
            if (typeThreeName.equals(Utils.getString(R.string.fushi))) {
                allBetNum = BetNumUtil.zhiXuanFuShi(officialSeletorList, typeOneName);
            } else if (typeThreeName.equals("组选24")) {
                allBetNum = (int) BetNumUtil.combineWithArraySize(officialSeletorList.size(), 4);
            } else if (typeThreeName.equals("组选12")) {
                allBetNum = (int) BetNumUtil.combinZuXuan12_4_60_20WithSectionArray(officialSeletorList, 2, 2);
            } else if (typeThreeName.equals("组选6")) {
                allBetNum = (int) BetNumUtil.combineWithArraySize(officialSeletorList.size(), 2);
            } else if (typeThreeName.equals("组选4")) {
