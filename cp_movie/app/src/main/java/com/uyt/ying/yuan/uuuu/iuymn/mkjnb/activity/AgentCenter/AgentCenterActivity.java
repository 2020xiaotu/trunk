...
public class AgentCenterActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void bindView() {
        ...
        if(appName.equals(Utils.getString(R.string.shenboguoji))||appName.equals(Utils.getString(R.string.yingzhongcaipiao))){
            commisionTypeTv.setText("当前佣金");
        }else {
            commisionTypeTv.setText("累计佣金");
        }
    ...
    private void initRecycleView() {
        ...
        agentCenterModelArrayList.add(new AgentCenterModel("代理说明",R.drawable.dailishuoming));
        agentCenterModelArrayList.add(new AgentCenterModel("下级开户",R.drawable.xiajikaihu));
        agentCenterModelArrayList.add(new AgentCenterModel("代理报表",R.drawable.dailibaobiao));
        agentCenterModelArrayList.add(new AgentCenterModel("下级管理",R.drawable.xiajigaungli));
        agentCenterModelArrayList.add(new AgentCenterModel(Utils.getString(R.string.xiajitouzhumingxi),R.drawable.xaijitouzhu));
        agentCenterModelArrayList.add(new AgentCenterModel(Utils.getString(R.string.xiajijiaoyimingxi),R.drawable.xiajijiaoyi));
        int showAgentInCome = SharePreferencesUtil.getInt(MyApplication.getInstance(), CommonStr.AGENT_IN_CONE, 1);
        if(showAgentInCome==0){
            agentCenterModelArrayList.add(new AgentCenterModel(Utils.getString(R.string.dailichongzhi),R.drawable.dailichongzhi));
        }
    ...
    private void getChild() {
        ...
        Utils.docking(dataInfo, RequestUtil.REQUEST_wt32, 0, new DockingUtil.ILoaderListener() {//手机端下级报表
            ...
            public void success(String content) {
                ...
                yestodayChild.setText("昨天返佣:"+yesterdayCommission);
                todayChild.setText("今日返佣:"+todayCommission);
                childNum.setText("我的下级:"+childAllRegisterPeopleNum+"人");
                if(appName.equals(Utils.getString(R.string.shenboguoji))||appName.equals(Utils.getString(R.string.yingzhongcaipiao))){
                    //显示个人中心的佣金
