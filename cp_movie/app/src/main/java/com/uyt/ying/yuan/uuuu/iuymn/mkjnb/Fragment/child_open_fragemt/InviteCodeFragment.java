...
//                    String inviteCode, String createdDate, String num, String codeUrl, String k3Rate, String happytenRate,
                    inviteCodeArrayList.add(new InviteCode("邀请码:"+inviteCode,format,"注册("+num+")",url,k3Rate,happytenRate,sscaiRate,happy8Rate,xuanwuRate,farmRate,raceRate,sixRate,danRate));
                }
...
//                popupWindow.setOutsideTouchable(true); //设置popupWindow能否响应外部的点击事件
            ...
            case R.id.delete_img:
                ...
                isExit.setTitle("删除邀请码");
                isExit.setMessage("确定删除?");
