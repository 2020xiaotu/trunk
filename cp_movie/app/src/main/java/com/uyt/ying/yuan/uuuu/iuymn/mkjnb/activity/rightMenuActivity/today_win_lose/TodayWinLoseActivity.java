...
//        refreshLayout.setEnableAutoLoadMore(false);//取消自动加载更多
    ...
    private void requestBetList(final boolean isloadMore) {
        ...
        Utils.docking(data, RequestUtil.REQUEST_11r, 0, new DockingUtil.ILoaderListener() {
            ...
            public void success(String content) {
                ...
                betCountTv.setText("总笔数:"+totalsize1);
                winloseAmountTvRight.setText("总输赢"+sumMoney);
                winloseAmountTvLeft.setText("总输赢"+sumMoney);//左侧占位置的textview 保持和右侧总输赢的内容一样
               ...
               /* allAmount=BigDecimal.ZERO;
                ...
                betCountTv.setText("总笔数:"+todayWinLoseModelArrayList.size()+"");
                winloseAmountTvRight.setText("总输赢"+allAmount+"");
                winloseAmountTvLeft.setText("总输赢"+allAmount+"");
               */
    ...
    private void bindView() {
        ...
        actionBarCenterTv.setText("今日已结");
