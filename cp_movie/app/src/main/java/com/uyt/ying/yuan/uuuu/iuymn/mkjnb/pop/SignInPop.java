...
public class SignInPop extends BasePopupWindow2 {
    ...
    private void initRulePop() {
        if(rulePop ==null){
//            rulePop = new RulePop(mContext,true,"file:///android_asset/signIn_rule.html","签到规则");
            rulePop = new RulePop(mContext,true, Utils.checkImageUrl("/rules/signIn_rule.html"),"签到规则");
        }
