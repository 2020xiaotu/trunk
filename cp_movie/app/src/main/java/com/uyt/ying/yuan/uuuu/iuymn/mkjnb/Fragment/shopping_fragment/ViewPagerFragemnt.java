...
//                        Long countTime = SharePreferencesUtil.getLong(getActivity(), "lcountTime", 0l);//本地和服务器时间差
                        ...
                        CountDown newCountDown = new CountDown(finalUrl, typename, num, "距离第" + currentLotteryQiShu +"期截止还有", "1", currentLotteryTime, countTime, id, type_id,isopenOffice,isStart,game,waitLotteryQiShu,lastLotteryQiShu);
...
//                        if(isStart.equals("1")){
                            CountDown countDown = new CountDown(finalUrl, typename, num, "距离第" + currentLotteryQiShu +"期截止还有", "1", currentLottery, countTime, id,type_id,isopenOffice,isStart,game,waitLotteryQiShu,lastLotteryQiShu);
...
//                    }
                    ...
                    if(waitLotteryQiShu!=null&&lastLotteryNo!=null){
                        ...
                        CountDown countDown = new CountDown(finalUrl, typename, num, "距离第" + currentLotteryQiShu +"期截止还有", "1", currentLotteryTime, 100, id,type_id,isopenOffice,isStart,game,waitLotteryQiShu,lastLotteryQiShu);
                        countDowns.add(countDown);
                    }
