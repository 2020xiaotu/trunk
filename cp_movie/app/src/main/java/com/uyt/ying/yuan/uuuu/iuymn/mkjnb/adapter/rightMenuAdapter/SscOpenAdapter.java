    ...
    public void onBindViewHolder(@NonNull SscOpenAdapter.MyHolder myHolder, int position) {
        ...
        if(sscOpenResultModel.isGuanYa()){
            ...
            for (int i = 0; i < strings.size(); i++) {
                ...
                if(openNum.equals("单")|| openNum.equals("大")|| openNum.equals("龙")){
