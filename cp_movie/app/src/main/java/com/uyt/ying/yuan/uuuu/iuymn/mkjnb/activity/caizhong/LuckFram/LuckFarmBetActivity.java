...
//                                Integer group_id = jsonObject2.getInteger("id");
        ...
        if (popPosition == 0) {
            ...
            happy10ModelList.add(new Happy10Model(Utils.getString(R.string.disiqiu),"","",getString(R.string.liangmiandisiqiu)));
            ...
            happy10ModelList.add(new Happy10Model(Utils.getString(R.string.diwuqiu),"","",getString(R.string.liangmiandiwuqiu)));
            ...
            happy10ModelList.add(new Happy10Model(Utils.getString(R.string.diliuqiu),"","",getString(R.string.liangmiandiliuqiu)));
            ...
            happy10ModelList.add(new Happy10Model(Utils.getString(R.string.diqiqiu),"","",getString(R.string.liangmiandiqiqiu)));
            ...
            happy10ModelList.add(new Happy10Model(Utils.getString(R.string.dibaqiu),"","",getString(R.string.liangmiandibaqiu)));
            ...
            happy10ModelList.add(new Happy10Model(type, "", "", type + "-第一球"));
            ...
            happy10ModelList.add(new Happy10Model(lianmaType,"","",getString(R.string.lianmagang)+typename));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.xingyong_play:
                showToast(getString(R.string.zhanwugaiyouxiguanfangwanfa));
                break;
...
//                customPopupWindow.showHappy8TodayResultPop(todayOpenResultLinear,this);
    ...
    private void randomBet(ArrayList<Happy10Model> happy10MedolList, int num) {
        ...
        for (int i = 0; i < selecterList.size(); i++) {
            String betType = selecterList.get(i).getBetType();
            if(betType.equals(Utils.getString(R.string.renxuaner))|| betType.equals(Utils.getString(R.string.renxuaner))|| betType.equals(Utils.getString(R.string.renxuaner))|| betType.equals(Utils.getString(R.string.renxuaner))|| betType.equals(getString(R.string.xuanerlianzu))){
