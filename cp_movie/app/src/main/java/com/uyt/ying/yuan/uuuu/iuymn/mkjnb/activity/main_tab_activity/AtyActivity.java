        ...
        Utils.docking(data, RequestUtil.REQUEST_33r, 1, new DockingUtil.ILoaderListener() {
            ...
            public void success(String content) {
                ...
                if(showMemberGradeAward==0){
                    AtyCenter aty = new AtyCenter(R.drawable.ac_icon1, "晋级奖励", "会员每晋升一个等级,都能获得奖励,最高可得88888元","weizhi",1,1,"");
                    atyCenterArrayList.add(aty);
                }
                if(showCodeAmountMyself==0){
                    AtyCenter aty1 = new AtyCenter(R.drawable.ac_icon1, "每日加奖", "每日加奖是根据会员昨日投注金额,进行一定比例的加奖","weizhi",1,1,"");
