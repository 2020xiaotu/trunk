...
public class ManualRechargeActivity extends BaseActivity implements BasePopupWindow2.OnPopClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CommonToolbarUtil.initToolbar(this,"人工充值");
...
//                }
    ...
    private void initManualTipPop() {
        if(manualRechargeTipPop==null){
            manualRechargeTipPop = new ManualRechargeTipPop(ManualRechargeActivity.this,true,"1、即将受封为众神之长。在巅峰时刻，他却因一时之过被贬下凡间。失去神力，被世人唾弃。1、即将受封为众神之长。在巅峰时刻，他却因一时之过被贬下凡间。失去神力，被世人唾弃。1、即将受封为众神之长。在巅峰时刻，他却因一时之过被贬下凡间。失去神力，被世人唾弃。1、即将受封为众神之长。在巅峰时刻，他却因一时之过被贬下凡间。失去神力，被世人唾弃。1、即将受封为众神之长。在巅峰时刻，他却因一时之过被贬下凡间。失去神力，被世人唾弃。1、即将受封为众神之长。在巅峰时刻，他却因一时之过被贬下凡间。失去神力，被世人唾弃。","代充提示");
